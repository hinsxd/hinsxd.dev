...
Type alias is used to give a type another name, and it is useful when you want to give a more descriptive name to a type.
We can also define custom methods on a type alias. This will be discussed more in the next section.
